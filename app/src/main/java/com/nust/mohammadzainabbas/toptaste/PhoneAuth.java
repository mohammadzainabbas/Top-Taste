package com.nust.mohammadzainabbas.toptaste;
/*
...
public class PhoneAuth extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(number.charAt(0) == '0' && number.charAt(1) == '3') {
            String valid_number = number.replaceFirst("03", "+923");
            mPhoneNumberField.setText(valid_number);
        }
